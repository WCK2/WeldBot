...
from tools.devices.D435 import D435, rgbd_read_data
from tools.pc.target_transformation import *
import time
...
if __name__ == '__main__':
    ...
    fname = 'd435_2025-02-25_14-52-05'
    ...
    detections, draw_img = detect_and_estimate_tags(img, camera_params, camera_distortion, show=False)
    print(detections)
